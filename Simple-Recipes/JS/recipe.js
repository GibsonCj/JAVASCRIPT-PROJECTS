...
document.getElementById('contactForm').addEventListener('submit',
    function (event) {
        //Overrides the default browser refresh when the submit button is clicked
        ...
        //Email pattern checks for all the symbols that would be needed for an email address such as the @ and . and the text that would come before, between, and active
